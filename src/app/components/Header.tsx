...
export default function HeaderComponent() {
  ...
  return (
    <Suspense>
      <header
        className={`z-10 fixed xl:left-[3.5rem] xl:right-[3.5rem] top-[0rem]  flex flex-col py-[1.5rem] md:px-[1.25rem] justify-between items-center self-stretch bg-background sm:left-[1.25rem] sm:right-[1.25rem]  ${
          menuActive
